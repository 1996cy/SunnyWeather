...
private val sky= mapOf(
    ...
    "PARTLY_CLOUDY_DAY" to Sky("多云", R.drawable.ic_partly_cloud_day,R.drawable.bg_partly_cloudy_night),
    ...
    "LIGHT_SLEET" to Sky("小雪", R.drawable.ic_light_snow,R.drawable.bg_snow),
    "MODERATE_SLEET" to Sky("中雪", R.drawable.ic_moderate_snow,R.drawable.bg_snow),
    "HEAVY_SLEET" to Sky("大雪", R.drawable.ic_heavy_snow,R.drawable.bg_snow),
    "STORM_SLEET" to Sky("暴雪", R.drawable.ic_heavy_snow,R.drawable.bg_snow),
